...
CREATE OR REPLACE TABLE `t1engenhariadados.LivrariaDevSaber_Grupo_3_12.Clientes` (
    ID_Cliente      INT64,
    Nome_Cliente    STRING,
...
CREATE OR REPLACE TABLE `t1engenhariadados.LivrariaDevSaber_Grupo_3_12.Produtos` (
    ID_Produto          INT64,
    Nome_Produto        STRING,
...
CREATE OR REPLACE TABLE `t1engenhariadados.LivrariaDevSaber_Grupo_3_12.Vendas` (
    ID_Venda   INT64,
    ID_Cliente INT64,
    ID_Produto INT64,
    Data_Venda DATE,
